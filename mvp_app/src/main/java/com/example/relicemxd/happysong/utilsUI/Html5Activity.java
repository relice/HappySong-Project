...
public class Html5Activity extends Activity implements OnClickListener {
    ...
    private void initView() {
        ...
        ivBack = (ImageView) findViewById(R.id.page_title_back_img);
        ivClose = (ImageView) findViewById(R.id.page_title_close_img);
        webView = (WebView) findViewById(R.id.webview_layout_html);
        tvView = (TextView) findViewById(R.id.page_title_tv);
...
//                        dialog.dismiss();
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.page_title_back_img:
                if (webView != null && webView.canGoBack()) {
                    webView.goBack();
                    checkShowBackImg();
                }
                break;
            case R.id.page_title_close_img:
                finish();
                break;
        }
    }
