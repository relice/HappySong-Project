package com.happysong.app.utils.gsyvideoplayer.view;
...
public class SwitchVideoTypeDialog extends Dialog {
    ...
    public SwitchVideoTypeDialog(Context context) {
        super(context, com.happysong.app.R.style.dialog_style);
    ...
    public void initList(List<SwitchVideoModel> data, OnListItemClickListener onItemClickListener) {
        ...
        View view = inflater.inflate(com.happysong.app.R.layout.switch_video_dialog, null);
        listView = (ListView) view.findViewById(com.happysong.app.R.id.switch_dialog_list);
        setContentView(view);
        adapter = new ArrayAdapter<>(mContext, com.happysong.app.R.layout.switch_video_dialog_item, data);
