...
import com.happysong.app.utils.gsyvideoplayer.view.ScrollWebView;
...
public class WebDetailActivity extends AppCompatActivity {
    ...
    @Bind(com.happysong.app.R.id.scroll_webView)
    ScrollWebView webView;
    @Bind(com.happysong.app.R.id.web_player)
    StandardGSYVideoPlayer webPlayer;
    @Bind(com.happysong.app.R.id.web_top_layout)
    NestedScrollView webTopLayout;
    @Bind(com.happysong.app.R.id.web_top_layout_video)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.happysong.app.R.layout.activity_web_detail);
