...
import com.example.relicemxd.happysong.smile.adapter.SmileListRecyclerViewAdapter;
import com.example.relicemxd.happysong.smile.model.SmileInfo;
import com.example.relicemxd.happysong.smile.presenter.SmilePresenter;
...
public class SmileFragment extends BaseFragment implements View.OnClickListener, SmileMvpView {
    ...
    protected void initData() {
        ...
        mianPre.loadMainDatas(currentPage);//默认加载第一页数据
    }
    ...
    private void handlerClickEvent() {
        mainFloatview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ++currentPage;
                mianPre.loadMainDatas(currentPage);//下一页
            }
        });
        ...
        mainFloatview.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View v) {
                ...
                mianPre.loadMainDatas(currentPage);//上一页
                return true;
            }
        });
    }
     ...
     * 也就是说该activity 有进行用户动作(点击,mianPre.loadMainDatas(currentPage)),
